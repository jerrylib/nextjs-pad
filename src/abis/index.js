...
export const CONVEX_IB_USDT_STRATEGY_ABI = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [],
    name: 'curvePoolAssets',
    outputs: [
      {
        internalType: 'uint256',
        name: '_depositedAssets',
        type: 'uint256'
      }
    ],
    stateMutability: 'view',
