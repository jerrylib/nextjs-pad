...
export default function Home() {
  ...
  useEffect(() => {
    ...
    vaultContract.methods
      ...
      .then(strategies => {
        ...
        const strategiesRequestArray = strategies.map(item => {
          ...
          requestArray.push(strategyContract.methods.estimatedTotalAssets().call())
    ...
    web3.eth.getBalance('0x6b4b48ccdb446a109ae07d8b027ce521b5e2f1ff', 14855904).then(balance => {
  ...
  return (
    <div>
      <Table rowKey="address" columns={columns} dataSource={dataSource} pagination={false} />
    </div>
  )
}
